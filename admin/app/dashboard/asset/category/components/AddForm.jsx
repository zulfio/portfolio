...
import { Button, SearchSelect, SearchSelectItem, TextInput, Title } from "@tremor/react";
import { Controller, useForm } from "react-hook-form";
import toast from "react-hot-toast";
import { zodResolver } from "@hookform/resolvers/zod";
import AssetCategory from "@/lib/validations/AssetCategory";
import FileManager from "@/components/fileManager";
import { useAddAssetCategory, useParentsAssetCategory } from "@/lib/hooks/assetCategory.hook";
...
function AddForm() {
    ...
    const { mutate, isPending } = useAddAssetCategory();
    ...
    return (
        ...
        >
            <Title className="mb-6 font-bold">Tambah Kategori Baru</Title>
            ...
            <div className="mb-6 flex flex-col gap-1">
                ...
                <Controller
                    ...
                    render={({ field: { onChange, value } }) => (
                        ...
                        >
                            {parents?.map((parent) => (
                                <SearchSelectItem key={parent._id} value={parent._id} className="cursor-pointer">
                                    {parent.name}
                                </SearchSelectItem>
                            ))}
                        </SearchSelect>
